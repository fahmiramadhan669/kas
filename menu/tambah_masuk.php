  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
       ...
       <li><a href="cetak_laporan.php"><i class='fa fa-print'></i> <span>Cetak Laporan</span></a></li>
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Penanggung jawab"  name="penanggung" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Keterangan</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Keterangan" name="ket" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">tanggal</label>
                      <input type="date" class="form-control" id="exampleInputEmail1" placeholder="tanggal" name="tgl" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Jumlah</label>
                      <input type="number" class="form-control" id="exampleInputPassword1" placeholder="jumlah" name="jml" required>
                    </div> 
                  </div><!-- /.box-body -->
